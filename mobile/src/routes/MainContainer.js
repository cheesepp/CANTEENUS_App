...
import StaffDetailScreen from '../screens/HomeScreen/StaffScreen/StaffDetailScreen/StaffDetailScreen';
...
const staffDetailName = 'StaffDetail';
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        ...
        options={homeHeaderBarStyle}></Stack.Screen>
      <Stack.Screen
        name={objectiveName}
      ...
      <Stack.Screen
        ...
        component={StaffDetailScreen}></Stack.Screen>
    </Stack.Navigator>
  );
}
...
function StaffHomeNavigator() {
  return (
    <Stack.Navigator>
      <Stack.Screen
        name={staffMainPage}
        component={StaffHomeScreen}></Stack.Screen>
      <Stack.Screen
        name={staffCartName}
        component={StaffCartScreen}></Stack.Screen>
    </Stack.Navigator>
  );
}
  ...
  return (
    <Stack.Navigator>
      <Stack.Screen
        ...
        component={CustomerHomeScreen}></Stack.Screen>
      <Stack.Screen
        name={customerCartName}
        component={CustomerCartScreen}></Stack.Screen>
    </Stack.Navigator>
  );
}
...
const homeHeaderBarStyle = StyleSheet.create({
  ...
  headerRight: () => <AntDesign size={20} name="plus" color={'white'} />,
});
...
function BillStackNavigator() {
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        name={billRatingName}
        component={RatingScreen}></Stack.Screen>
    </Stack.Navigator>
  );
}
...
function MainScreen() {
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        name={homeName}
        component={RoleNavigator({role: user.role})}
        options={{headerShown: false}}
      />
      <Tab.Screen
        name={billStack}
